# <p align="center">Deep Q-Learning project</p>
...
train.py:  
A python script to train an agent to play the Atari game Breakout using a Deep Q-Network (DQN) algorithm.  
Libraries used: numpy, pillow, tensorflow, keras, keras-rl2, gymnasium.

play.py:  
A python script to visualize the trained agent playing Breakout.  
