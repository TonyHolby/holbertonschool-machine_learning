#!/usr/bin/env python3
"""
    A function that creates, builds and trains a genism fastText model.
"""
import gensim
    ...
    """
        ...
        Args:
            ...
            min_count (int): the minimum number of occurrences of a word for
                use in training.
            negative (int): the maximum distance between the current and
                predicted word within a sentence.
            window (int): the size of negative sampling.
